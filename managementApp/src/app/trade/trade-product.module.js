(function() {
  ...
  angular
    ...
    .component('tradeProduct', {
      templateUrl: 'app/trade/trade-product.template.html',
      controller: TradeProductController,
      controllerAs: 'vm'
    });

  TradeProductController.$inject = ['$q', '$log', 'toastr', 'dataService', '$auth'];

  function TradeProductController($q, $log, toastr, dataService, $auth) {

    //Change this vars for a new base service on Rails
    var apiEndpointName = "trade-products";
    //
