(function() {
  ...
  angular
    ...
    .component('tradeGroup', {
      templateUrl: 'app/trade/trade-group.template.html',
      controller: TradeGroupController,
      controllerAs: 'vm'
    });

  TradeGroupController.$inject = ['$q', '$log', 'toastr', 'dataService', '$auth'];

  function TradeGroupController($q, $log, toastr, dataService, $auth) {

    //Change this vars for a new base service on Rails
    var apiEndpointName = "trade-groups";
    //
    ...
    vm.title = "Trade-group Management";
    vm.add = add;
    vm.remove = remove;
    vm.edit = edit;
    vm.save = save;
